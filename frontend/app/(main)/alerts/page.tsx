...
import { EVENT_SEVERITY_COLORS } from '@/utils/constants';
import {
  callsToEvents,
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          {isLoading ? (
            ...
            <EmptyState
              ...
              description="미응답 통화, 고위험 어르신, 디바이스 미등록 등의 조치 필요 항목이 여기에 표시됩니다."
              icon={
      ...
      {filter !== 'action_needed' && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          {isLoading ? (
            ...
            <EmptyState
              title="이벤트가 없습니다"
              description="통화 완료, 미응답, 고위험 분석 결과, 기기 상태 변경 등의 이벤트가 여기에 기록됩니다."
              className="py-12"
              icon={
