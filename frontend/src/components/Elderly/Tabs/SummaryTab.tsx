...
export default function SummaryTab({ elderly, recentCalls, connectedDevice, onStartCall }: SummaryTabProps) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
          ...
          {lastCall ? (
            ...
            <p className="text-gray-400">상담 기록 없음</p>
          )}
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-red-700 mt-1">
                최근 상담에서 {highRiskCalls.length}건의 고위험 상황이 감지되었습니다.
                상담 내역을 확인해주세요.
              </p>
              <Link
